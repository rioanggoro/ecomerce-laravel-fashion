                            ...
                            <form action="{{route('cart.update')}}" method="POST">
                                ...
                                @if(Helper::getAllProductFromCart())
                                    ...
                                    <tr>
                                        ...
                                        <td class="image" data-title="No">
                                            <img src="{{$photo[0]}}" class="img-fluid rounded" style="max-height: 100px" alt="{{$photo[0]}}">
                                        </td>
                                        ...
                                        <td class="qty" data-title="Qty">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <input type="text" name="quant[{{$key}}]" class="rounded px-2" data-min="1" data-max="100" value="{{$cart->quantity}}">
                                ...
                                <tr>
                                    <td class="text-center" colspan="6">
                                        ...
                                        <a href="{{route('product-grids')}}" class="text-primary">Lanjut Belanja</a>
                                    </td>
                                </tr>
                                @endif
                            </form>
                            ...
                            <div class="left">
                                <div class="coupon">
                                    <form action="{{route('coupon-store')}}" method="POST">
                                        @csrf
                                        <input name="code" class="form-control" placeholder="Masukkan kode kupon" type="text">
                            ...
                            <div class="right">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">
                                        Kamu hemat <span>Rp{{number_format(Session::get('coupon')['value'], 2)}}</span>
                                    </li>
                                    @endif
                                ...
                                <div class="button5">
                                    <a href="{{route('checkout')}}" class="btn btn-dark">Checkout <i class="fa fa-long-arrow-right"></i></a>
                                    <a href="{{route('product-grids')}}" class="btn btn-secondary">Lanjut Belanja</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<style>
    ...
    @media (max-width: 576px) {
        ...
        .shopping-summery td .price, .shopping-summery td .qty {
            text-align: center;
        }
    }
</style>
