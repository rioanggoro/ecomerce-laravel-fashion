...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 rounded-top">
      ...
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Tambah Brand"><i class="fas fa-plus"></i> Tambah Brand</a>
    </div>
    <div class="card-body">
